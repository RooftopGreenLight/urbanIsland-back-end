...
import rooftopgreenlight.urbanisland.dto.reservation.ReservationPartDto;
...
public class RooftopDto {
    ...
    private List<ReservationPartDto> reservations;
    ...
    protected RooftopDto(Long id, Integer totalPrice, String city, String district, String detail, String explainContent, String roleContent,
        ...
        this.reservations = reservations.size() > 0
                ? reservations.stream().map(ReservationPartDto::from).collect(Collectors.toList())
                : null;
    }

package rooftopgreenlight.urbanisland.repository.chat;
...
public interface ChatRoomRepository extends JpaRepository<ChatRoom, Long>,
    ...
    @Query("select c from ChatRoom c where c.rid=:rooftopId and c.memberId=:memberId " +
    ...
    @Query("select c from ChatRoom c where c.rid=:rooftopId and c.ownerId=:ownerId")
